...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            app::commands::set_automation_rule_enabled,
            ...
            app::commands::reapply_quick_tag_changes,
            app::commands::preview_quick_group,
            app::commands::apply_quick_group,
            app::commands::revert_quick_group_changes,
            app::commands::reapply_quick_group_changes,
            app::commands::preview_quick_artist_prefix,
