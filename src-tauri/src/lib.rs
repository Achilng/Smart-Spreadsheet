...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            app::commands::get_compare_sample,
            app::commands::query_compare_same_artists,
            app::commands::query_compare_same_vibe_diff_style,
            app::commands::query_compare_same_style_diff_vibe,
            app::commands::query_compare_same_style_all_models,
