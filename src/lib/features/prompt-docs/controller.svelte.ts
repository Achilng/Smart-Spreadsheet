...
/** Per-instance state and operations for the PromptDocsView view. */
export function createPromptDocsController() {
  ...
  return {
    ...
    set activeDoc(value: typeof activeDoc) { activeDoc = value; },
    get title() { return title; },
    set title(value: typeof title) { title = value; },
    get search() { return search; },
    set search(value: typeof search) { search = value; },
    get loading() { return loading; },
    set loading(value: typeof loading) { loading = value; },
    get switchingDoc() { return switchingDoc; },
    set switchingDoc(value: typeof switchingDoc) { switchingDoc = value; },
    get saveState() { return saveState; },
    set saveState(value: typeof saveState) { saveState = value; },
    get editorElement() { return editorElement; },
    set editorElement(value: typeof editorElement) { editorElement = value; },
    get editor() { return editor; },
    set editor(value: typeof editor) { editor = value; },
    get filteredDocs() { return filteredDocs; },
