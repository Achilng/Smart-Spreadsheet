<script lang="ts">
  ...
  import { app, errorText, formatCount } from "../app-state.svelte";
  import { resetRows, rowStore, setDedupe, setFilter, setHideGrouped, setSingleArtistOnly } from "../row-store.svelte";
  import {
    clearSelection,
    getSelectedCount,
